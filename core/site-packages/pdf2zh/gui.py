...
def setup_gui(
    ...
    Outputs:
        - None
    """
    # Auto-find available port if the specified port is in use
    available_port = find_available_port(server_port, max_attempts=50)
    if available_port is None:
        raise OSError(f"Cannot find available port in range {server_port}-{server_port + 50}")
